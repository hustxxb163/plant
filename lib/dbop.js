...
var add_collaborator = function(_id, user, callback) {
  var dev = {person: {_id: user._id, uid: user.uid},
             joined_at: new Date()};
  collection.repos.update({_id: _id},
                          {$push: {collaborators: dev}},
                          callback);
};

var del_collaborator = function(_id, dev_id, callback) {
  collection.repos.update({_id: _id},
                          {$pull: {collaborators: {'person._id': dev_id}}},
                          callback);
};
...
exports.add_collaborator = add_collaborator;
exports.del_collaborator = del_collaborator;
